...
export const metadata: Metadata = {
  title: "Style-Ok - Fashion Brand Shop | Curated Styles",
  description: "Discover fashion that expresses your unique style at Style-Ok. Shop curated collections of contemporary clothing designed for the modern trendsetter.",
  keywords: "fashion, clothing, style, boutique, trendy apparel, fashion shop",
  openGraph: {
    title: "Style-Ok - Fashion Brand Shop",
    description: "Discover fashion that expresses your unique style",
    siteName: "Style-Ok",
    type: "website"
  },
  twitter: {
    ...
    title: "Style-Ok - Fashion Brand Shop",
    description: "Shop curated fashion collections"
  }
};
